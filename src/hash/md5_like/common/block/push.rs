    ...
    [u8; SIZE]: Sized,
{
    ...
    pub(in crate::hash::md5_like::common) fn push_byte(&mut self, byte: u8) {
    ...
    pub(in crate::hash::md5_like::common) fn push_bytes(
        &mut self,
    ...
    /// # Panic
    /// This function will panic if the block already contains `SIZE` elements
    pub(in crate::hash::md5_like::common) fn push_slice(&mut self, slice: &[u8]) {
    ...
    pub(in crate::hash::md5_like::common) fn consume(&mut self) -> &[u8] {
